        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    interact = GUILayout.Toggle(interact, "");
                    if (GUI.changed)
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    var mute = false;
                    mute = GUILayout.Button("Mute", GUILayout.ExpandWidth(false), GUILayout.ExpandHeight(true));
                    if (GUI.changed)
                    { SoundManager.Instance.masterVolume = volume; }
                    if(GUI.changed && mute)
                    {
                        SoundManager.Instance.masterVolume = -80.0f;
                    }
                }
                GUILayout.EndHorizontal();
